...
```{r Directories}
datadir <- "Integrate_Glia+Neurons/scRNA_data/"
outdir <- "scRNA_data/"
...
# Uses pkg SeuratDisk
SaveH5Seurat(seu.WT, filename = paste0(outdir, "wt_glia+neurons_seurat_V1.h5Seurat"))
Convert(paste0(outdir, "wt_glia+neurons_seurat_V1.h5Seurat"), dest = "h5ad")

SaveH5Seurat(seu.KO, filename = paste0(outdir, "ko_glia+neurons_seurat_V1.h5Seurat"))
Convert(paste0(outdir, "ko_glia+neurons_seurat_V1.h5Seurat"), dest = "h5ad")
